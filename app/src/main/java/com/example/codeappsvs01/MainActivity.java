...
public class MainActivity extends AppCompatActivity {
    ...
    private void ponerImagenes(){
        // Lógica para establecer imágenes en los slots
    ...
    private void dineroAcumulado() {
        // Lógica para calcular las ganancias y actualizar el saldo
    ...
    private void insertPlayerResultInDatabase(PlayerResult playerResult) {
        // Lógica para insertar el resultado del jugador en la base de datos
